        ...
        <>
            ...
            <div className='container mx-auto py-5 px-6'>
                ...
                <form onSubmit={handleSubmit} className="max-w-2xl mx-auto">
                    ...
                    <div className="my-6">
                        <button onClick={redirect} type="submit" className="block w-full p-2 text-white bg-blue-500 rounded-lg hover:bg-blue-600 focus:ring-blue-500 focus:ring-4 focus:outline-none dark:focus:ring-blue-800 font-medium text-sm">Save</button>
                    </div>
                </form>
            </div>
        </>
