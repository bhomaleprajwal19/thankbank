...
export default function Home() {
  return (
    <>
      <div className="flex justify-center flex-col gap-4 items-center text-white h-[44vh] px-5 md:px-0 text-xs md:text-base  ">
        <div className="font-bold flex gap-6 md:gap-20 md:text-5xl justify-center items-center text-3xl">ThankBank <span><img className="invertImg" src="/heart.png" width={50} alt="" /></span></div>
        ...
        <div>
          ...
          <button type="button" className="bg-blue-600 px-4 py-2 m-2 rounded-xl hover:rounded-full w-32">Start Here</button>
          </Link>

          <Link href="/about">
          <button type="button" className="bg-blue-600 px-4 py-2 m-2 w-32 rounded-xl hover:rounded-full">Read More</button>
          </Link>
  ...
  <div className="flex gap-5 justify-center sm:justify-around">
    <div className="item space-y-3 flex flex-col items-center justify-center">
      <img className="bg-slate-400 rounded-full  object-fill text-black" width={88} src="/support.png" alt="Support" />
    ...
    <div className="item space-y-3 flex flex-col items-center justify-center">
      <img className="bg-slate-400 rounded-full  object-contain text-black" width={88} src="/vision.png" alt="Contribution" />
    ...
    <div className="item space-y-3 flex flex-col items-center justify-center">
      <img className="bg-slate-400 rounded-full object-contain text-black " width={88} src="/teamwork.png" alt="Collaboration" />
